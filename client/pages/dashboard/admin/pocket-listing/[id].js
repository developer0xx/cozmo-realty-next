...
const Pocket = ({ userInfo, id, preFetchedPocket }) => {
    ...
    const submitVerifiedHandler = async e => {
        e.preventDefault();
        let body = {
            ...data,
            id: id,
    ...
    console.log(data.propertySubType)
    ...
    return <DashboardLayout userInfo={userInfo}>
        <section id="create" style={{ height: '100vh' }}>
            <Container>
                ...
                <Row>
                    <Col sm={12} md={4}>
                        <Button className="w-100" onClick={submitHandler}>Save</Button>
                    </Col><Col sm={12} md={4}>
                        <Button className="w-100" onClick={submitVerifiedHandler}>Publish</Button>
                    </Col>
                </Row>
            </Container>
        </section>
