...
const fetchPockets = async (cookieHeader) => {
    return await axios({
        method: 'GET',
        url: `${API}/pockets/dashboard/agent`,
        headers: {
...
const headCells = [
    ...
    { id: 'phoneNumber', numeric: true, disablePadding: false, label: 'Status' },
];
    ...
    return (
        ...
        >
            ...
            <Tooltip title="Add new request">
                <Link href="/dashboard/agent/pocket-listing/create/">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell component="th" id={labelId} scope="row" padding="none">
                                                    <Link href={`/dashboard/agent/pocket-listing/${row._id}`}>
                                                        <a className='d-block'>
                                                ...
                                                <TableCell align="right">  <Link href={`/dashboard/agent/pocket-listing/${row._id}`}>
