...
const fetchClaims = async (cookieHeader) => {
    return await axios({
        method: 'GET',
        url: `${API}/claims`,
        headers: {
...
const headCells = [
    { id: 'category', align: 'center', disablePadding: false, label: 'Category' },
    { id: 'address', align: 'left', disablePadding: false, label: 'Address' },
    { id: 'fullName', align: 'center', disablePadding: false, label: 'Full Name' },
    { id: 'email', align: 'left', disablePadding: false, label: 'Email' },
    { id: 'phoneNumber', align: 'center', disablePadding: false, label: 'Phone Number' },
];
                    ...
                    <TableContainer>
                        ...
                        >
                            ...
                            <TableBody>
                                ...
                                {rows.map((row, i) => (
                                    stableSort(row.claimers, getComparator(order, orderBy))
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">
                                                        {row.pocketId ? row.pocketId.property.line1 + ' ' + row.pocketId.property.line2 + ' ' + row.pocketId.property.city : ''}
                                                    </TableCell>
...
export const getServerSideProps = async ctx => {
    ...
    const claims = await fetchClaims(cookieHeader);
    console.log(claims)
    return { props: { userInfo, claims } };
};
